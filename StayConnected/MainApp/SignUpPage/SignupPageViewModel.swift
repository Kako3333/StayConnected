...
class SignupViewModel {
    ...
    func signup(
        ...
        let postUrl = "https://ios-stg.stayconnected.digital/api/users/"
        ...
        networkService.postData(to: postUrl, modelType: CustomUserResponse.self, requestBody: userRequest) { result in
            DispatchQueue.main.async {
                ...
                case .success(let userResponse):
                    ...
                    print("Email: \(String(describing: userResponse.email))")
                    print("Name: \(String(describing: userResponse.first_name)) \(String(describing: userResponse.last_name))")
